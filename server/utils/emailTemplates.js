/**
 * Email template generators for ResuCraft
 */
...
const getPasswordResetTemplate = (resetUrl) => `
  <div style="font-family: 'Inter', Helvetica, Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e5e7eb; border-radius: 12px; background-color: #ffffff;">
    ...
    <p style="color: #4b5563; font-size: 16px; line-height: 1.5; margin-bottom: 24px;">
      You requested to reset your ResuCraft password. Click the button below to choose a new password. This link is only valid for 15 minutes.
    </p>
...
`;
/**
 * Returns the HTML email template for email change verification
 * @param {string} verifyUrl - The email verification link
 * @returns {string} HTML string
 */
const getEmailChangeTemplate = (verifyUrl) => `
  <div style="font-family: 'Inter', Helvetica, Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e5e7eb; border-radius: 12px; background-color: #ffffff;">
    <h2 style="color: #111827; font-size: 24px; font-weight: 700; margin-bottom: 16px;">Verify Your New Email</h2>
    <p style="color: #4b5563; font-size: 16px; line-height: 1.5; margin-bottom: 24px;">
      You requested to change your ResuCraft account email to this address. Click the button below to confirm. This link is only valid for 15 minutes.
    </p>
    <div style="text-align: center; margin-bottom: 24px;">
      <a href="${verifyUrl}" style="background-color: #4f46e5; color: #ffffff; padding: 12px 24px; font-size: 16px; font-weight: 600; text-decoration: none; border-radius: 8px; display: inline-block;">
        Verify Email
      </a>
    </div>
    <p style="color: #6b7280; font-size: 14px; margin-bottom: 24px;">
